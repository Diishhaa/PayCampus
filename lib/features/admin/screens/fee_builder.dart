    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text("You are about to publish '${_nameController.text}' of amount ₹${_amountController.text} to all students in $_targetGrade. This action will notify parents immediately via SMS and email. Proceed?"),
          actions: [
            TextButton(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Row dividing Form Inputs and Real-time Preview card
              Row(
              ...
              // Late Fee & Waiver Rules Sections
              Text(
                ...
                child: Column(
                  children: [
                    SwitchListTile(
                      ...
                      subtitle: const Text("Attach penalty charges to outstanding bills post due date", style: TextStyle(fontSize: 12)),
                      value: _applyLateFee,
                    ...
                    SwitchListTile(
                      ...
                      subtitle: const Text("Permit scholarships, subsidies, and manual discounts", style: TextStyle(fontSize: 12)),
                      value: _allowWaivers,
                      activeColor: AppColors.primary,
                      onChanged: (val) {
                        setState(() {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                ...
                style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: AppColors.primary, letterSpacing: 0.5),
              ),
              Text(
                _targetGrade,
                style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: AppColors.textSecondary, letterSpacing: 0.5),
              ),
            ],
          ),
          const SizedBox(height: 12),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Invoice Total", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
              Text(
                "₹$amount",
          ...
          if (_applyLateFee) ...[
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text("Late Penalty", style: TextStyle(fontSize: 10, color: AppColors.error)),
                Text(
